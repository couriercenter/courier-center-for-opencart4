...
$events = [
    ...
    ['courier_center_update_notice',  'Courier Center — ειδοποίηση διαθέσιμης ενημέρωσης',    'admin/view/common/header/after',                    'extension/couriercenter/shipping/courier_center_update.notice',             0],
];
